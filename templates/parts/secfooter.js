...
<h2 class='h__h2--secondary m-design__h2 h--bright'>${page.title}</h2>
...
<div class="m-search__related-results container__scrollable container__scrollable--wrap container__scrollable--slim"><a href="${page.canonical}" class="link vc-pill vc-pill--on-light link--default">
<span class='link__content'>
${page.site_name}
</span>

</a>
<a href="${page.canonical}" class="link vc-pill vc-pill--on-light link--default">
<span class='link__content'>
SITUS ${page.site_name}
</span>
...
<li>
<a aria-label="Share to Twitter" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="${page.canonical}share?url=https%3A%2F%2Ftee.pub%2Flic%2F0CmpsQ5Pozk&amp;text=Check out this awesome &#39;Muppet+Christmas+Carol+-+Come+In+And+Know+Me+Better+Man&#39; design on @TeePublic!" class="link jsTwitterProductShare gtmTwitterProductShare twitter link--1 link--default">
<span class='link__content'>
...
<li>
<a aria-label="Share to Facebook" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="${page.canonical}sharer/sharer.php?u=https://tee.pub/lic/0CmpsQ5Pozk" class="link gtmFbProductShare facebook link--1 link--default">
<span class='link__content'>
...
<li>
<a aria-label="Share to Linktree" target="_blank" href="${page.canonical}admin?url=https://tee.pub/lic/0CmpsQ5Pozk&amp;title=${page.title}&amp;action=create-link&amp;utm_source=addthisbutton&amp;utm_channel=TeePublic" class="link gtmLinktreeProductShare linktree link--1 link--default">
<span class='link__content'>
...
<li>
<a aria-label="Save to Pinterest" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="${page.canonical}pin/create/button/?url=https%3A%2F%2Ftee.pub%2Flic%2F0CmpsQ5Pozk&amp;media=https%3A%2F%2Fimages.teepublic.com%2Fderived%2Fproduction%2Fdesigns%2F54469715_0%2F1702220495%2Fi_p%3Ac_191919%2Cs_630%2Cq_90.jpg&amp;description=Check+out+this+awesome+%27Muppet%2BChristmas%2BCarol%2B-%2BCome%2BIn%2BAnd%2BKnow%2BMe%2BBetter%2BMan%27+design+on+%40TeePublic%21" class="link jsPinterestProductShare gtmPinterestProductShare pinterest link--1 link--default">
<span class='link__content'>
...
<li>
<a aria-label="Share to Reddit" target="_blank" href="${page.canonical}/submit?url=https%3A%2F%2Ftee.pub%2Flic%2F0CmpsQ5Pozk" class="link gtmRedditProductShare reddit link--1 link--default">
<span class='link__content'>
...
<li>
<a aria-label="Share to Tumblr" target="_blank" href="${page.canonical}widgets/share/tool?posttype=link&amp;canonicalUrl=https%3A%2F%2Fwww.teepublic.com%2F&amp;content=https%3A%2F%2Ftee.pub%2Flic%2F0CmpsQ5Pozk&amp;caption=Check out this awesome &#39;Muppet+Christmas+Carol+-+Come+In+And+Know+Me+Better+Man&#39; design on @TeePublic!" class="link jsTumblrProductShare gtmTumblrProductShare tumblr link--1 link--default">
<span class='link__content'>
